...
parseTable "block_statements" "FOLLOW" = ["EOF", "void", "int", "}", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue", "else"]
parseTable "statements" "FIRST" = ["void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "statements" "FOLLOW" = ["}"]
parseTable "statement" "FIRST" = ["void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "statement" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "assignment_or_general_func_call" "FIRST" = ["identifier"]
parseTable "assignment_or_general_func_call" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "assignment_or_general_func_call_tail" "FIRST" = ["[", "=", "("]
parseTable "assignment_or_general_func_call_tail" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "printf_func_call" "FIRST" = ["printf"]
parseTable "printf_func_call" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "printf_func_call_tail" "FIRST" = [")", ","]
parseTable "printf_func_call_tail" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "scanf_func_call" "FIRST" = ["scanf"]
parseTable "scanf_func_call" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "read_func_call" "FIRST" = ["read"]
parseTable "read_func_call" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "write_func_call" "FIRST" = ["write"]
parseTable "write_func_call" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
...
parseTable "if_statement" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "if_statement_tail" "FIRST" = ["else"]
parseTable "if_statement_tail" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
...
parseTable "while_statement" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "return_statement" "FIRST" = ["return"]
parseTable "return_statement" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "return_statement_tail" "FIRST" = ["identifier", "number", "-", "(", ";"]
parseTable "return_statement_tail" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "break_statement" "FIRST" = ["break"]
parseTable "break_statement" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
parseTable "continue_statement" "FIRST" = ["continue"]
parseTable "continue_statement" "FOLLOW" = ["}", "void", "int", "identifier", "printf", "scanf", "read", "write", "if", "while", "return", "break", "continue"]
